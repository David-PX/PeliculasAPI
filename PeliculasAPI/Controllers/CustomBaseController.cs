...
namespace PeliculasAPI.Controllers
{
    public class CustomBaseController : ControllerBase
    {
        ...
        protected async Task<ActionResult> Post<TCreacion, TEntidad, TLectura>(TCreacion cractioDTO, string nombreRuta) where TEntidad : class, IId
        {
            var entidad = mapper.Map<TEntidad>(cractioDTO);
            context.Add(entidad);
