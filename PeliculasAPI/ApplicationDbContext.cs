...
namespace PeliculasAPI
{
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        private void SeedData(ModelBuilder modelBuilder)
        {
            ...
            var aventura = new Generos() { Id = 4, Nombre = "Aventura" };
            var animation = new Generos() { Id = 5, Nombre = "Animación" };
            var suspenso = new Generos() { Id = 6, Nombre = "Suspenso" };
            var romance = new Generos() { Id = 7, Nombre = "Romance" };

            modelBuilder.Entity<Generos>()
                .HasData(new List<Generos>
                {
        ...
        public DbSet<SalaDeCine> SalasDeDines { get; set; }
